...
import { addrci } from "../../../actions/routines/rciActions";
...
class Newrci extends Component {
  constructor() {
    super();
    this.state = {
        fecha: new Date(),
  ...
  onSubmit = e => {
    ...
    this.props.addrci(nueva, this.props.history)
  };
    ...
    <Grid item xs={12}>
      <Card container className={classes.root} variant="outlined">
          ...
          <CardContent align="center">
              <Typography variant="h4" style={{color:"#F59C00"}} gutterBottom>Iniciar nueva rutina de gabinetes :</Typography>
              <br/>
...
Newrci.propTypes = {
    ...
    addrci: PropTypes.func.isRequired,

...
import { addSilleteria } from "../../../actions/routines/silleteriaActions";
...
class NewSilleteria extends Component {
  constructor() {
    super();
    this.state = {
        fecha: new Date(),
  ...
  onSubmit = e => {
    ...
    this.props.addSilleteria(nueva, this.props.history)
  };
...
NewSilleteria.propTypes = {
    getUsers: PropTypes.func.isRequired,
    addSilleteria: PropTypes.func.isRequired,
